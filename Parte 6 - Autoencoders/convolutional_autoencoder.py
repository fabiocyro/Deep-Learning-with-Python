...
''' o objetivo dessa linha acima é pegar onde está o output do autoencoder,
que fica justamente na camada Flatten()'''
...
for i, indice_imagens in enumerate(imagens_teste):
    ...
    plt.imshow(imagens_codificadas[indice_imagens].reshape(16,8))
    plt.xticks(())
    plt.yticks(())
