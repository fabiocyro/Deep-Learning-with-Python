...
#segunda aula pós criada a rede, feita para melhorar a qualidade  

#Essa base de dados mnist já possui a divisão entre treinamento e teste
(X_treinamento, y_treinamento) , (X_teste, y_teste) = mnist.load_data()
plt.imshow(X_treinamento[1], cmap = 'gray')
plt.title('Classe: ' + str(y_treinamento[0]))

#Conversão necessário de modo a trabalhar com o tensorflow
